...
ID3D10ShaderResourceView* TextureMgr::createTex(wstring filename)
{
	...
	std::wstring prefix = L"..\\..\\T2\\";
	HR(D3DX10CreateShaderResourceViewFromFile(md3dDevice, (prefix + filename).c_str(), 0, 0, &rv, 0 ));
...
ID3D10ShaderResourceView* TextureMgr::createTexArray(wstring arrayName, const StringVector& filenames)
{
	...
	for(UINT i = 0; i < arraySize; ++i)
	{
        ...
        HR(D3DX10CreateTextureFromFile(md3dDevice, (prefix + filenames[i]).c_str(), 
...
ID3D10ShaderResourceView* TextureMgr::createCubeTex(std::wstring filename)
{
	...
	std::wstring prefix = L"..\\..\\T2\\";
	HR(D3DX10CreateTextureFromFile(md3dDevice, (prefix + filename).c_str(), 
