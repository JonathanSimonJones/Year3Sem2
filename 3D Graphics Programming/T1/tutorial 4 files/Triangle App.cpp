...
void ColoredTriangleApp::updateScene(float dt)
{
    ...
    //if(GetAsyncKeyState('P') & 0x8000)	scale += dt*1000;
	//if(GetAsyncKeyState('O') & 0x8000)	scale -= dt*1000;
...
void ColoredTriangleApp::buildFX()
{
	...
	HRESULT hr = 0;
	hr = D3DX10CreateEffectFromFile(L"..\\..\\T1\\tutorial 4 files\\color.fx", 0, 0, 
