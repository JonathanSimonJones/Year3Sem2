...
#ifndef DSOUNDUTILITY_H_v1_1
#define DSOUNDUTILITY_H_v1_1
...
public:
	...
	//--- Returns the 3D listener interface to the primary buffer.
	LPDIRECTSOUND3DLISTENER8 Get3dListener ();
...
public:
	...
	//--- Return the 3D buffer interface to the sound buffer.
	LPDIRECTSOUND3DBUFFER8 Get3dBuffer ();
	...
	//--- Change playing properties by relative amount.
	void ChangeFrequency (DWORD freqChange);	// in Hz.
	void ChangeVolume (LONG volChange);		// in 1/100 Db.
	void ChangePan (LONG panChange);		// in 1/100 Db.
